<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:103:"/Volumes/HighSierraFile/HighSierraFile/www/new/tp2/public/../application/index/view/article/article.htm";i:1525781980;s:89:"/Volumes/HighSierraFile/HighSierraFile/www/new/tp2/application/index/view/public/head.htm";i:1525614327;s:91:"/Volumes/HighSierraFile/HighSierraFile/www/new/tp2/application/index/view/public/footer.htm";i:1522395187;}*/ ?>
        ...
        <div id="container">
            <div id="content">
                <div class="post" id="post-19563" style="border-right: solid 1px #000000; min-height: 1700px;
                    margin-top: 10px;">
                    <div class="path"><a href='<?php echo url('index/index'); ?>'>主页</a> > <a href='<?php echo url('index/<?php if($cateres['type'] == 1): ?>artlist<?php endif; ?>/index',array('cateid' => $cateres['id'])); ?>'><?php echo $cateres['catename']; ?></a> > </div>
                    <div class="single_entry single2_entry">
                        <div class="entry fewcomment">
                            <div class="title_container">
                                <h2 class="title single_title">
                                    <span><?php echo $artres['title']; ?></span><span class="title_date"></span></h2>
                                <p class="single_info">时间：<?php echo date("Y年m月d日 m:s",$artres['time']); ?>&nbsp;&nbsp;&nbsp;编辑：<?php echo $artres['author']; ?></p>
                            </div>
