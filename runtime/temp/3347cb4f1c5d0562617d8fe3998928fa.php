<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:97:"/Volumes/HighSierraFile/HighSierraFile/www/new/tp2/public/../application/index/view/page/page.htm";i:1522395187;s:89:"/Volumes/HighSierraFile/HighSierraFile/www/new/tp2/application/index/view/public/head.htm";i:1525613923;s:91:"/Volumes/HighSierraFile/HighSierraFile/www/new/tp2/application/index/view/public/footer.htm";i:1522395187;}*/ ?>
...
<ul id="jsddm">
  ...
  <li><a href="http://tp2.com/public/index/<?php if($cate['type'] == 1): ?>artlist<?php elseif($cate['type'] == 2): ?>page<?php elseif($cate['type'] == 3): ?>imglist<?php endif; ?>"><?php echo $cate['catename']; ?></a>
    <?php if($cate['second'] != ''): ?>
    <ul>
      <?php foreach($cate['second'] as $value){ ?>
      <li><a href="/lookbike/fixed-gear/"><?php echo $value['catename']; ?></a></li>
      <?php }?>
    </ul>
    <?php endif; ?>
  </li>
