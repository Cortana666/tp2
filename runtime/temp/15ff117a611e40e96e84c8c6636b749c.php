<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:96:"/Volumes/HighSierraFile/HighSierraFile/www/new/tp2/public/../application/admin/view/conf/lst.htm";i:1524232777;s:88:"/Volumes/HighSierraFile/HighSierraFile/www/new/tp2/application/admin/view/public/top.htm";i:1522757993;s:89:"/Volumes/HighSierraFile/HighSierraFile/www/new/tp2/application/admin/view/public/left.htm";i:1524143272;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
													...
													<tbody>
														<?php if(is_array($confres) || $confres instanceof \think\Collection || $confres instanceof \think\Paginator): $i = 0; $__LIST__ = $confres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$conf): $mod = ($i % 2 );++$i;?>
															<tr>
																	...
																	<td align="center">
																		<input style="width:20px;" type="text" name="<?php echo $conf['id']; ?>" value="<?php echo $conf['sort']; ?>">
																	</td>
																	<td align="center"><?php echo $conf['enname']; ?></td>
																	<td align="center"><?php echo $conf['cnname']; ?></td>
																	<td align="center"><?php if($conf['type'] == 1): ?>单行文本
																		<?php elseif($conf['type'] == 2): ?>多行文本
																		<?php elseif($conf['type'] == 3): ?>单选框
																		<?php elseif($conf['type'] == 4): ?>复选框
																		<?php elseif($conf['type'] == 5): ?>下拉列表
																		<?php endif; ?>
																	</td>
