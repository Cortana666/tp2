<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:98:"/Volumes/HighSierraFile/HighSierraFile/www/new/tp2/public/../application/admin/view/admin/edit.htm";i:1524137019;s:88:"/Volumes/HighSierraFile/HighSierraFile/www/new/tp2/application/admin/view/public/top.htm";i:1522757993;s:89:"/Volumes/HighSierraFile/HighSierraFile/www/new/tp2/application/admin/view/public/left.htm";i:1523878601;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
											<input class="form-control" placeholder="" name="id" required="" type="hidden" value="<?php echo $adminres['id']; ?>">
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">管理员名称</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="name" required="" type="text" value="<?php echo $adminres['name']; ?>">
                            </div>
