<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:99:"/Volumes/HighSierraFile/HighSierraFile/www/new/tp2/public/../application/admin/view/login/login.htm";i:1525351080;}*/ ?>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml"><!--Head--><head>
    ...
    <!--Beyond styles-->
    <link id="beyond-link" href="http://tp2.com/public/static/admin/style/beyond.css" rel="stylesheet">
    ...
    <div class="login-container animated fadeInDown">
        <form action="" method="post">
            <div class="loginbox bg-white">
                ...
                <div class="loginbox-textbox">
                    <input class="form-control" style="width:100px;float:left;" placeholder="yanzhengma" name="captcha" type="text">
                    <img style="float:left" src="<?php echo captcha_src(); ?>" onclick="this.src='<?php echo captcha_src(); ?>?'+Math.random()" alt="captcha" />
                </div>
