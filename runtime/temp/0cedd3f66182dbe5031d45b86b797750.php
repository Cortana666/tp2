<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:97:"/Volumes/HighSierraFile/HighSierraFile/www/new/tp2/public/../application/admin/view/cate/edit.htm";i:1525608983;s:88:"/Volumes/HighSierraFile/HighSierraFile/www/new/tp2/application/admin/view/public/top.htm";i:1522757993;s:89:"/Volumes/HighSierraFile/HighSierraFile/www/new/tp2/application/admin/view/public/left.htm";i:1524143272;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                    ...
                    <form class="form-horizontal" role="form" action="" method="post">
													...
													<div class="col-sm-6">
															<select name="pid" style="width: 100%;">
																...
																<?php if(is_array($cateres) || $cateres instanceof \think\Collection || $cateres instanceof \think\Paginator): $i = 0; $__LIST__ = $cateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?>
																 <option <?php if($data['pid'] == $cate['id']): ?>selected="selected"<?php endif; ?> value="<?php echo $cate['id']; ?>"><?php echo str_repeat('---',$cate['level']) ?><?php echo $cate['catename']; ?></option>
                            ...
                            <p class="help-block col-sm-4 red">* 必填</p>
												...
												<div class="form-group">
														...
														<div class="col-sm-6">
																<input class="form-control" placeholder="" name="keywords" required="" type="text" value="<?php echo $data['keywords']; ?>">
														</div>
														<p class="help-block col-sm-4 red">* 必填</p>
												</div>
                        ...
                        <div class="form-group">
                            <label for="group_id" class="col-sm-2 control-label no-padding-right">栏目类型</label>
                                ...
                                <div class="radio" style="float:left;margin-right:10px">
																	<label>
																		<input value="1" <?php if($data['type']==1): ?>checked="checked"<?php endif; ?> type="radio" name="type" class="basic">
																		<span class="text">文章列表</span>
																	</label>
                                </div>
																<div class="radio" style="float:left;margin-right:10px">
																	<label>
																		<input value="2" <?php if($data['type']==2): ?>checked="checked"<?php endif; ?> type="radio" name="type" class="inverted">
																		<span class="text">单页列表</span>
																	</label>
                                </div>
																<div class="radio" style="float:left;margin-right:10px">
																	<label>
																		<input value="2" <?php if($data['type']==3): ?>checked="checked"<?php endif; ?> type="radio" name="type" class="inverted">
