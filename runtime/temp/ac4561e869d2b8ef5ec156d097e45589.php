<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:97:"/Volumes/HighSierraFile/HighSierraFile/www/new/tp2/public/../application/admin/view/conf/edit.htm";i:1524142501;s:88:"/Volumes/HighSierraFile/HighSierraFile/www/new/tp2/application/admin/view/public/top.htm";i:1522757993;s:89:"/Volumes/HighSierraFile/HighSierraFile/www/new/tp2/application/admin/view/public/left.htm";i:1524143272;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="cnname" required="" type="text" value="<?php echo $conf['cnname']; ?>">
                            </div>
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="enname" required="" type="text" value="<?php echo $conf['enname']; ?>">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                            ...
                            <div class="col-sm-6">
                                <select class="" name="type" disabled="disabled">
																	...
																	<option value="3" <?php if($conf['type'] == 3): ?>selected="selected"<?php endif; ?>>单选框</option>
																	<option value="4" <?php if($conf['type'] == 4): ?>selected="selected"<?php endif; ?>>复选框</option>
																	<option value="5" <?php if($conf['type'] == 5): ?>selected="selected"<?php endif; ?>>下拉列表</option>
                                </select>
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
